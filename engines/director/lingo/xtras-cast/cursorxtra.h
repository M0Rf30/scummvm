...
struct Info {
	...
	uint32 sizePx = 0;
	uint32 intervalMs = 0;
	uint32 member1 = 0;		// first referenced bitmap cast member
	uint32 member2 = 0;		// second referenced bitmap cast member
	uint32 frameCount = 0;
};
...
public:
	...
	bool getCursorInfo(CastMemberID &image, CastMemberID &mask) override;
